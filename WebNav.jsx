...
const WebNav = () => {
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand" exact activeClassName="menu_active" to="/"> React App</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <NavLink className="nav-link active" aria-current="page" exact activeClassName="menu_active" to="/">Home</NavLink>
        </li>
